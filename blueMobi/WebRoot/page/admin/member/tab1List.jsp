...
<body>
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center',border:false"
			...
			<table id="priTB" title="" style="width:inherit;height:auto;"
				pagination="true"
				...
				<thead>
				<th field="id" width="100"  checkbox="true">編号</th>				
			    <th field="enrollDate" width="140" sortable="true"  align="center">面试时间</th>	
			    <th field="partTitle" width="160" sortable="true"  align="center">面试工作</th>
