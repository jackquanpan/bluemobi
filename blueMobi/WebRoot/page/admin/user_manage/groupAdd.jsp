...
<body class="easyui-layout">
	<div class="add_order" id="Product"
		...
		<form id="add" method="post" class="ff">
			...
			<table width="91%" align="left" border="0">
				<tr >
					<td  width="15%" colspan="2"><span style="font-size:14px;"><b>预设名称</b></span></td>
					<td  width="15%"><input id="groupName" name="groupName" type="text" ></td>
					<td colspan="4"><input id="pro" type="checkbox" name="pro" style="width:10%; " value="0" onclick="selectAll()"/>全选</td>
				</tr>
						...
						<td style="background:#F0F8FF;"><span	style="font-size:14px; " >系统管理</span></td>
						...
						<td style="background:#F0F8FF;"><span	style="font-size:14px;">会员管理</span></td>
						...
						<td style="background:#F0F8FF;"><span	style="font-size:14px;">兼职管理</span></td>
						...
						<td style="background:#F0F8FF;"><span	style="font-size:14px;">资讯管理</span></td>
						...
						<td style="background:#F0F8FF;"><span	style="font-size:14px;">WEB配置</span></td>
						...
						<td style="background:#F0F8FF;"><span	style="font-size:14px;">广告管理</span></td>
						...
						<td style="background:#F0F8FF;"><span	style="font-size:14px;">数据统计</span></td>
						...
						<td colspan="5"><span style="font-size:12px;margin-left: 0px"><input id="pro23" type="checkbox" name="pro"  style="width:10%; " value="34" onclick="select1(23)"/>网站收入编辑</span></td>					
						
						</tr>
						<tr>
						<td style="background:#F0F8FF;"><span	style="font-size:14px;">8</span></td>
						<td style="background:#F0F8FF;"><span	style="font-size:14px;">消息管理</span></td>						
						...
						<td style="background:#F0F8FF;" ><span	style="font-size:14px;">启动页管理</span></td>						
...
function submits() {
	...
	if ($("#add").form("validate")){
		...
		ajaxFunction($("base")[0].href + "admin/addGroup.htm",{
			groupName:groupName,
			authCode:qx
		},function(data){
