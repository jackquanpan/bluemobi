    ...
    public static String getTime(Date time) {
        ...
        if (days == 0L) {
            ...
            if ((!is00.equals("0")) && (!is01.equals("0"))) {
                timeStr.append(time.toString().substring(5, 7) + "月" + time.toString().substring(8, 10) + "日"
                        + time.toString().substring(11, 16));
                return timeStr.toString();
            } else if ((!is00.equals("0")) && (is01.equals("0"))) {
                timeStr.append(time.toString().substring(5, 7) + "月" + time.toString().substring(9, 10) + "日"
                        + time.toString().substring(11, 16));

                return timeStr.toString();
            } else if ((is00.equals("0")) && (!is01.equals("0"))) {
                timeStr.append(time.toString().substring(6, 7) + "月" + time.toString().substring(8, 10) + "日"
                        + time.toString().substring(11, 16));

                return timeStr.toString();
            } else {
                timeStr.append(time.toString().substring(6, 7) + "月" + time.toString().substring(9, 10) + "日"
                        + time.toString().substring(11, 16));
